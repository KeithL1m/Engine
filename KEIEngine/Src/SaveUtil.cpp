...
void SaveUtil::SaveVector3(const char* key, const KMath::Vector3& v, rapidjson::Document& doc, rapidjson::Value& member)
{
...
void SaveUtil::SaveQuaternion(const char* key, const KMath::Quaternion& q, rapidjson::Document& doc, rapidjson::Value& member)
{
    rapidjson::GenericStringRef<char> str(key);
