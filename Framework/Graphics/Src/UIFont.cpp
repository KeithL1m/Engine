...
namespace
{
    ...
    inline uint32_t ToFontColor(const KEIEngine::Color& color)
    {
...
void UIFont::DrawString(const wchar_t* str, const KMath::Vector2& position, float size, const Color& color)
{
